...
import com.ddphin.ddphin.elasticsearch.indices.service.impl.ESSpuIdxService;
...
/**
 * ClassName: ESSpuIdxController
 * Function:  ESSpuIdxController
 * Date:      2019/6/21 下午3:19
 * Author     DaintyDolphin
 * Version    V1.0
 */
@RestController
@RequestMapping("/es/idx/spu")
public class ESSpuIdxController {
    @Autowired
    private ESSpuIdxService service;

    @PostMapping
    public ResponseEntity<MResponse>  create() throws Exception {
